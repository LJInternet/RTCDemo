...
namespace LJMediaLibrary {
    ...
    public:
         ...
         * @brief 请求远程关键帧。
         */
        virtual void requestRemoteKeyFrame() = 0;
...
/**
 * @brief Interface for controlling media audio.
 */
    ...
    public:
        ...
        /**
         * @brief Update transmission status.
         *
         * @param isConnected Indicates whether the audio is connected.
         */
        virtual void updateTransStatus(bool isConnected) = 0;

        /**
         * @brief Create the audio controller.
         */
        ...
        /**
         * @brief Handle media events.
         *
         * @param event_type The type of the event.
         * @param strData Data associated with the event.
        ...
        /**
         * @brief Adjust the encoding bitrate.
         *
         * @param bitrateInbps Bitrate in bits per second.
         */
        virtual void adjustEncodeBitrate(int bitrateInbps) = 0;

        /**
         * @brief Handle audio media get events.
         *
         * @param eventType The type of the event.
         * @param mediaData Audio media data.
         * @param len Length of the media data.
         * @param retLen Pointer to the return length.
         * @return The result of the operation.
         */
        virtual char *HandleAudioMediaGetEvent(int eventType, char *mediaData, int len, int * retLen) = 0;

        /**
         * @brief Initialize the audio JNI environment.
         *
         * @param context The JNI environment context.
         * @param enable Flag to enable/disable the initialization.
         */
