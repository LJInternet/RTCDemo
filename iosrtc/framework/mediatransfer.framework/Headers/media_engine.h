...
{
        struct TransDelayInfo *timeInfos; /**< Array of transfer delay information. */
...
struct CNeedDecodeVideoFrame
{
        ...
        struct TransDelayInfoList *delayData; /**< Delay data associated with the video frame. */
};
...
MEDIATRANSFER_EXTERN typedef int (*audio_data_cb)(void *audioData, int size, int64_t pts,
